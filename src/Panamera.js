...
export class Panamera extends React.Component {
    componentDidMount(){
      window.scrollTo(0,0);
    }
    state={
    ...
    render() {
        return (
            ...
            <header className="App-header App-header-panamera">
              ...
              <div className="bottom-text">
                <p className="car-name">Porsche Panamera</p>
              </div>
            </header>
            <section>
              <div id="infopage" className="infopage">
                <div className="info-text2">
                  ...
                  <p className="infopage-car-name">Porsche Panamera</p>
                  <p><span className="infopage-car-year">2019 <br/></span></p>
                  ...
                  <div className="text-mobile-none">
                    <div className="infopage-left-elem">
                      ...
                      <p className="infopage-left-info">4.0L V-образный <br/>8-цилиндровый</p>
                    </div>
                    <div className="infopage-left-elem">
                      <p className="infopage-left-title">Мощность</p>
                      <p className="infopage-left-info">460 л.с./338 кВт</p>
                    </div>
                    <div className="infopage-left-elem">
                      <p className="infopage-left-title">Разгон 0-100 км/ч</p>
                      <p className="infopage-left-info">4,1 сек</p>
                    </div>
                  </div>
                </div>
                <img className="photo" src={require('./img/cropped2.jpg')} alt=""/>
              ...
              <div className="idea-page">
                <div className="top-idea-block">
                    <div className="top-idea-block-text">
                          <div className="top-idea-block-title">Идея Panamera GTS</div>
                          <div className="top-idea-block-info">Стремясь к высоким целям, невозможно обойтись без смелости и страстности. Это впечатляющим образом доказал Panamera</div>
                    </div>
                    <div className="top-idea-block-images">
                    <Carousel showThumbs={false}>
                        <div>
                            <img src={require("./img/PA19P3LID0003_low.jpg")} />
                        </div>
                        <div>
                            <img src={require("./img/PA19P3LID0002_low.jpg")} />
                        </div>
                        <div>
                            <img src={require("./img/PA19P3LID0001_low.jpg")} />
                        </div>
                    </Carousel>
                    </div>
                </div>
                <div id="macan" className="bottom-idea-block">
                    <div className="bottom-block-image">
                      <img src={require('./img/design.jpg')} alt=""/>
                    </div>
              ...
              <div id="info4">
                  <div className="info2">
                  <div style={{backgroundImage:"url("+require('./img/PA19P3LOX0004_low.jpg')+")"}} className="info-elem">
                  ...
                  <div style={{backgroundImage:"url("+require('./img/PA19P3LID0002_low.jpg')+")"}}  className="info-elem">
                  ...
                  <div className="info2">
                   <div style={{backgroundImage:"url("+require('./img/PA19P3AOX0001_KV_low.jpg')+")"}}  className="info-elem">
                  ...
                  <div style={{backgroundImage:"url("+require('./img/PA19P3LOX0007_KV_low.jpg')+")"}}  className="info-elem">
